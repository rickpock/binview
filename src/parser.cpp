...
long readExtraField(FILE *fp, long parentOffset, Node *parentNode)
{
    ...
    addChildNode(extraFieldNode, extraFieldHeaderNode); // TODO: Break down header
    addChildNode(extraFieldHeaderNode,
        new Node("Header ID", 0x0, 0x2, new EnumInterpretation("unknown", IntInterpretation::OPT_INCL_HEX | IntInterpretation::OPT_LITTLE_ENDIAN, {
